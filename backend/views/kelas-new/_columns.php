...
return [
    ...
    [
        ...
        'value' => function ($model) {
            $thn_ajaran = $model->getThnAjaran()->one();
            $text = $thn_ajaran->tahun_mulai;
            $text .= ' - ';
            $text .= $model->thnAjaran->tahun_selesai;
            return $text;
        }
    ],
    [
        ...
        'header'=>'Detail',
        'value' => function ($model) {
            $link = Html::a('Detail', ['kelas-new/detail', 'id' => $model->id], ['data-pjax' => 0]) ;
            return $link;
        }
    ],
    [
